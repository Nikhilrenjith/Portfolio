  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src="./logo.svg" className="logo" alt="Logoipsum" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://github.com/Nikhilrenjith"
            ...
            <li>
              <a
                href="https://twitter.com/NikhilStriker"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://linkedin.com/in/nikhil-renjith"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Work Still in progress</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
